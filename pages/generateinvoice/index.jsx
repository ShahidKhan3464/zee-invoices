...
import { GenerateInvoiceStyled, InvoiceModalBodyStyle, InvoiceBuilderForm, InvoiceBuilderHeader } from "styles/generateInvoiceBuilderStyle";
...
const Index = () => {
  ...
  const [invoicetitle, setInvoicetitle] = useState("Invoice: 001")
  ...
  console.log(invoiceBuilderFormData, 'invoice')
  ...
  const deleteTableRowHandler = (selectedId) => {
    const filterdArray = invoiceBuilderFormData.filter(
  ...
  const SenderInputBox = () => {
    return (
      <div className='invoice_builder_page_body_from_senderDetail'>
        ...
        >
          <img
            alt='senderDetailPlusIcon.svg'
            src='images/senderDetailPlusIcon.svg'
          />
          <p>Add New Sender</p>
        </div>
      </div>
